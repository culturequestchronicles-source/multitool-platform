    ...
    <main style={{ background: "#f9fafb" }}>
      ...
      <section id="tools" style={{ padding: 50 }}>
        ...
        <div style={grid}>
          ...
          <ToolCard
            title="Split PDF"
            description="Split pages easily"
          ...
          <ToolCard
            title="PDF → Word"
            description="Editable Word file"
        ...
        <div style={grid}>
          ...
          <ToolCard
            title="JSON → Excel"
            description="Excel friendly JSON"
        ...
        <div style={grid}>
          ...
          {/*
          ⛔ COMMENTED OUT: Excel Diff Checker
          <ToolCard
        ...
        <div style={grid}>
          ...
          - Prompt Generator for Coders
          - Safety Prompt Generator
        ...
        {/*
        ⛔ COMMENTED OUT: AI Conversions section
